...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1156569746291203418L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"com.fizalise.orderservice.event\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"surname\",\"type\":\"string\"}]}");
   ...
   */
  public OrderPlacedEvent(java.lang.CharSequence orderId, java.lang.CharSequence email, java.lang.CharSequence name, java.lang.CharSequence surname) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: surname = (java.lang.CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static com.fizalise.orderservice.event.OrderPlacedEvent.Builder newBuilder() {
    return new com.fizalise.orderservice.event.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.fizalise.orderservice.event.OrderPlacedEvent.Builder newBuilder(com.fizalise.orderservice.event.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.fizalise.orderservice.event.OrderPlacedEvent.Builder();
    } else {
      return new com.fizalise.orderservice.event.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.fizalise.orderservice.event.OrderPlacedEvent.Builder newBuilder(com.fizalise.orderservice.event.OrderPlacedEvent other) {
    if (other == null) {
      return new com.fizalise.orderservice.event.OrderPlacedEvent.Builder();
    } else {
      return new com.fizalise.orderservice.event.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fizalise.orderservice.event.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fizalise.orderservice.event.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fizalise.orderservice.event.OrderPlacedEvent.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fizalise.orderservice.event.OrderPlacedEvent.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fizalise.orderservice.event.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fizalise.orderservice.event.OrderPlacedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fizalise.orderservice.event.OrderPlacedEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fizalise.orderservice.event.OrderPlacedEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fizalise.orderservice.event.OrderPlacedEvent.Builder setSurname(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fizalise.orderservice.event.OrderPlacedEvent.Builder clearSurname() {
      surname = null;
    ...
    public OrderPlacedEvent build() {
      try {
        ...
        record.surname = fieldSetFlags()[3] ? this.surname : (java.lang.CharSequence) defaultValue(fields()[3]);
        return record;
